...
{    
    ...
    public function index()
    {
        if(permission('personal-loan-installment-access')){
            $this->setPageData('Manage Personal Loan Installment','Manage Personal Loan Installment','fas fa-warehouse',[['name'=>'Loan','link'=>'javascript::void();'],['name' => 'Manage Personal Loan Installment']]);
            $data = [
